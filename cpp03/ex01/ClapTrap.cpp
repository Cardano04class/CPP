...
ClapTrap::ClapTrap(std::string name) : hitPoints(10), energyPoints(10), attackDamage(0){
    this->name = name;
    std::cout << "Calling ClapTrap parameterized constructor" << std::endl;
}
...
ClapTrap &ClapTrap::operator=(const ClapTrap &other)
{
    ...
    std::cout << "Calling ClapTrap copy assignment" << std::endl;
    return *this;
}

ClapTrap::~ClapTrap(){
    std::cout << "Calling ClapTrap destructor for " << name << std::endl;
}
